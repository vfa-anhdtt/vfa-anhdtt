...
import { SHAPE_TYPES, CONTROLS_DEFAULTS, LIMITS } from '../../../constants'
...
export const createRectangle = ({ x, y }) => {
    setState((state) => {
        state.shapes[nanoid()] = {
            ...
            width: CONTROLS_DEFAULTS.RECT.WIDTH,
            height: CONTROLS_DEFAULTS.RECT.HEIGHT,
            fill: CONTROLS_DEFAULTS.RECT.FILL,
            stroke: CONTROLS_DEFAULTS.RECT.STROKE,
            rotation: CONTROLS_DEFAULTS.RECT.ROTATION,
            x,
            y,
        }
    })
...
export const createCircle = ({ x, y }) => {
    setState((state) => {
        state.shapes[nanoid()] = {
            ...
            radius: CONTROLS_DEFAULTS.CIRCLE.RADIUS,
            fill: CONTROLS_DEFAULTS.CIRCLE.FILL,
            stroke: CONTROLS_DEFAULTS.CIRCLE.STROKE,
            x,
            y,
        }
    })
